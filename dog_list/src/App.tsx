        ...
        <div className="card">
            <div className="card-image">
                <figure className="image">
                    <img style={{aspectRatio: "1/1",objectFit: "contain",}} src={props.src} alt="cute dog" width={222} height={222} />
                </figure>
            </div>
        </div>
    );
...
const Form = (props: FormProps) => {
    const handleSubmit = (e: React.SyntheticEvent) => {
        ...
        const target = e.target as typeof e.target & {
            elements: { breed: HTMLSelectElement };
        };

        console.log(target.elements)
        const { breed } = target.elements;
...
const Footer = () => {
    return (
        <footer className="footer">
            ...
            <p>
                <a target="_blank" rel="noopener noreferrer" href="https://dog.ceo/dog-api/about">Donate to Dog API</a>
            </p>
            <p>
                This site is clone of <a target="_blank" rel="noopener noreferrer" href="https://zenn.dev/likr/articles/6be53ca64f29aa035f07">Reactチュートリアル1：犬画像ギャラリーを作ろう</a>
            </p>
        </footer>
    );
}
